# Gemini Master — Finpath Newsroom V5.1.9
...
>
> Pipeline orchestrator (`lib/stages/run_gemini_master.py`) substitutes
...
Bài bạn viết chạy song song với Grok Master ở cùng app — user toggle Gemini / Grok để so sánh.
