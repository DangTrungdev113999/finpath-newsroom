...
- **Cảnh báo nội bộ công ty CK**: vượt **150%** = yellow zone (công ty CK phải báo cáo SSC theo dõi)
...
| Quá tải | >150% | SSC quan ngại, công ty CK buộc tăng vốn |
...
- Cao hơn → công ty CK biên lãi tốt; thấp hơn → biên lãi bị nén

### Per-ticker positioning structural (KHÔNG per-quarter)

- **Top công ty CK** (SSI, VPS, TCBS): tỷ lệ dư nợ/VCSH thường 80-180% — competitive cho khách lẻ + tổ chức
- **Mid công ty CK** (HCM, VCI, MBS): 80-200% — niche segments (HCM mạnh khối ngoại, VCI mạnh IB)
- **Niche công ty CK** (SHS, FPTS): 60-130% — focus thị trường HNX hoặc retail địa phương
...
- [ck-brokerage-marketshare.md](./ck-brokerage-marketshare.md) — Thị phần môi giới gắn chặt với cho vay ký quỹ: công ty CK mạnh thị phần khách lẻ (VPS, TCBS) thường có dư nợ ký quỹ cao; ngược lại công ty CK mạnh khối ngoại + tổ chức (HCM, SSI) có dư nợ ký quỹ tương đối thấp hơn nhưng biên phí cao hơn.
- [ck-liquidity-sensitivity.md](./ck-liquidity-sensitivity.md) — Thanh khoản giảm 30% → cho vay ký quỹ giảm chỉ 10-15% lag 1-2 quý (sticky vs môi giới linear). Master nên hiểu lag effect khi viết bài về phục hồi/sụp.
- [ck-proprietary-trading.md](./ck-proprietary-trading.md) — Công ty CK tự doanh-heavy thường ít dư nợ ký quỹ-heavy (vốn phân bổ khác nhau). Tăng vốn cho cho vay ký quỹ thường đi kèm giảm tỷ trọng tự doanh.
