# Voice Layer 11 Rules — Master CK V1.5-lite

> Loaded from `Skill: finpath-newsroom-master-ck`. Apply CROSS-CUTTING toàn bộ 4 format. V1.5-lite (2026-05-13 PM) — definition-driven, no word lists.
