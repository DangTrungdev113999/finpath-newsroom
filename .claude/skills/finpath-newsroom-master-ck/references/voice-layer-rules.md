# Voice Layer 5 Rules — Master CK

> Loaded from `Skill: finpath-newsroom-master-ck`. Apply CROSS-CUTTING toàn bộ 4 format (flash_qa / standard_qa / standard_listicle / standard_narrative).
...
- Tốt: "Cổ phiếu sẽ tăng vì doanh thu ngân hàng đầu tư Q1 vượt 42%" (có direction + lý do)

### Test 2 — Direction check

Có cam kết direction không? → không = fail.
- Xấu: "Vẫn còn phải chờ thêm dữ liệu mới biết"
- Tốt: "Đà tăng có thể chững lại quý 2 nếu thanh khoản HOSE rơi dưới 18.000 tỷ/phiên" (có direction)
...
3. **Holder action** — `tích lũy giá oversold`, `đợi pullback`, `phòng thủ ưu tiên thị phần ổn định`, `chuyển hướng giá trị`
