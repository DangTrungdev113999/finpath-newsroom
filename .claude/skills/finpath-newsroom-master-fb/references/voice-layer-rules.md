# Voice Layer 7 Rules — Master FB V1.3

> Loaded from `Skill: finpath-newsroom-master-fb`. Apply CROSS-CUTTING toàn bộ 4 format (flash_qa / standard_qa / standard_listicle / standard_narrative).
