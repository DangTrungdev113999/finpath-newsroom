# Voice Layer 5 Rules — Master Logistics

> Loaded from `Skill: finpath-newsroom-master-logistics`. Apply CROSS-CUTTING toàn bộ 4 format (flash_qa / standard_qa / standard_listicle / standard_narrative).
...
- Tốt: "Cổ phiếu sẽ tăng vì cước phí vận tải container Q1 tăng 28% so cùng kỳ" (có direction + lý do)

### Test 2 — Direction check

Có cam kết direction không? → không = fail.
- Xấu: "Vẫn còn phải chờ thêm dữ liệu mới biết"
- Tốt: "Đà tăng có thể chững lại quý 2 nếu sản lượng thông quan các cảng phía Bắc giảm dưới 1 triệu TEU" (có direction)
...
3. **Holder action** — `tích lũy giá oversold`, `đợi pullback`, `phòng thủ ưu tiên cảng tải trọng cao`, `chuyển hướng giá trị`

### Tốt
- "Mã phù hợp NĐT giá trị giữ trên 18 tháng, ưu tiên cảng tải trọng cao hơn vận tải biển biến động theo cước phí."
- "Mã có rủi ro với NĐT short-term FOMO theo sóng cước. NĐT giữ giá trị nên đợi pullback 12-18 tháng."
