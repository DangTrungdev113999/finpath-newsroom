export function ArticleCardSkeleton() {
  return (
    <div
      aria-hidden
      className="flex flex-col overflow-hidden rounded-xl border border-fg-4/40 bg-bg-1"
    >
      {/* hero placeholder — matches both image cards and TickerHero cards */}
      <div className="relative aspect-video w-full overflow-hidden border-b border-fg-4/30 bg-bg-3 animate-pulse" />
